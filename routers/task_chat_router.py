...
# no need anymore its only used in phase one to save the dummy chats in the vinoth mongouri phase 2 noone save from the ai side all are handled by the backend
